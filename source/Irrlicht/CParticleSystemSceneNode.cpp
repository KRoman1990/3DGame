...
IParticleAttractionAffector* CParticleSystemSceneNode::createAttractionAffector(
	const core::vector3df& point, f32 m_speed, bool attract,
	bool affectX, bool affectY, bool affectZ )
{
	return new CParticleAttractionAffector( point, m_speed, attract, affectX, affectY, affectZ );
}
...
IParticleRotationAffector* CParticleSystemSceneNode::createRotationAffector(
	const core::vector3df& m_speed, const core::vector3df& pivotPoint )
{
	return new CParticleRotationAffector( m_speed, pivotPoint );
}
