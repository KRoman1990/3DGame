...
//! constructor
CParticleRotationAffector::CParticleRotationAffector( const core::vector3df& m_speed, const core::vector3df& pivotPoint )
		: PivotPoint(pivotPoint), Speed(m_speed), LastTime(0)
{
	#ifdef _DEBUG
