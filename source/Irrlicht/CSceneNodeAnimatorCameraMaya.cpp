...
void CSceneNodeAnimatorCameraMaya::setRotateSpeed(f32 m_speed)
{
	RotateSpeed = m_speed;
}
...
void CSceneNodeAnimatorCameraMaya::setMoveSpeed(f32 m_speed)
{
	TranslateSpeed = m_speed;
}


//! Sets the zoom speed
void CSceneNodeAnimatorCameraMaya::setZoomSpeed(f32 m_speed)
{
	ZoomSpeed = m_speed;
}
